    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="flex h-16 items-center justify-between">
            <span className="text-lg font-bold text-white tracking-tight">
              RAG<span className="text-sky-400">TAILOR</span>
            </span>
            <div className="flex items-center gap-6 text-sm">
              ...
              <a
                ...
                className="rounded-full bg-sky-500 px-4 py-2 text-sm font-semibold text-slate-950 hover:bg-sky-400 transition-colors"
              >
                문의하기
              </a>
            </div>
      ...
      <section className="relative min-h-screen flex items-center pt-16">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/2 -left-40 w-96 h-96 rounded-full bg-blue-600/8 blur-3xl" />
          <div className="absolute bottom-20 right-1/3 w-72 h-72 rounded-full bg-cyan-400/6 blur-3xl" />
          <div
        ...
        <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 py-24">
          <div className="max-w-4xl">
            <div className="mb-6">
              <span className="inline-flex items-center rounded-full border border-sky-500/30 bg-sky-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-sky-400">
            ...
            <p className="mt-8 text-lg sm:text-xl text-slate-300 max-w-2xl leading-relaxed">
              ...
              자체 데이터 처리 최적화{" "}
              <strong className="text-white">RAG 시스템 구축</strong>이
              Ragtailor의 핵심입니다.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a
                href="mailto:rex@ragtailor.com"
                className="inline-flex items-center gap-2 rounded-full bg-sky-500 px-8 py-3.5 text-sm font-semibold text-slate-950 hover:bg-sky-400 transition-all hover:shadow-lg hover:shadow-sky-500/25"
              >
                프로젝트 문의
                <svg
              ...
              <Link
                href="/notice"
                className="inline-flex items-center gap-2 rounded-full border border-slate-700 px-8 py-3.5 text-sm font-semibold text-slate-300 hover:border-slate-500 hover:text-white transition-colors"
              >
                공지사항 보기
              </Link>
            </div>
            ...
            <div className="mt-12 flex flex-wrap gap-2">
              {techStack.map((tech) => (
                <span
                  key={tech}
                  className="rounded-full border border-slate-700/80 bg-slate-800/50 px-3 py-1.5 text-xs font-medium text-slate-400"
                >
                  {tech}
                </span>
              ))}
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
          <div className="w-px h-12 bg-gradient-to-b from-transparent via-slate-500 to-transparent opacity-60" />
        </div>
      </section>
      ...
      <section id="services" className="py-24 px-6 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.3em] text-sky-400/90 mb-4">
              Value Proposition
            </p>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <article className="rounded-2xl border border-slate-800 bg-slate-900/50 p-8 hover:border-sky-500/40 hover:bg-slate-900/80 transition-all duration-300">
              <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-sky-500/10 text-sky-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="22"
                  height="22"
          ...
          <div className="mt-8 rounded-2xl border border-sky-500/20 bg-gradient-to-br from-sky-500/5 to-blue-600/5 p-8 sm:p-10">
            <div className="flex flex-col lg:flex-row lg:items-center gap-8">
              <div className="flex-1">
                <p className="text-xs uppercase tracking-[0.3em] text-sky-400/90 mb-3">
                  핵심 전문성
                </p>
              ...
              <div className="flex flex-col gap-3 lg:min-w-[260px]">
                {[
                  ...
                  >
                    <div className="h-2 w-2 rounded-full bg-sky-400 flex-shrink-0" />
      ...
      <section id="portfolio" className="py-20">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 mb-12 text-center">
          <p className="text-xs uppercase tracking-[0.3em] text-sky-400/90 mb-4">
            Portfolio
          </p>
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            ...
            <div className="marquee-track flex items-stretch gap-5">
              {portfolioItems.concat(portfolioItems).map((item, index) => (
                <div
                  ...
                  className="min-w-[280px] flex-shrink-0 rounded-2xl border border-slate-800 bg-slate-900 px-6 py-5"
                >
      ...
      <section className="py-24 px-6 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-10 sm:p-16 text-center">
            <p className="text-xs uppercase tracking-[0.3em] text-sky-400/90 mb-4">
              Contact
            </p>
            ...
            <a
              href="mailto:rex@ragtailor.com"
              className="inline-flex items-center gap-3 rounded-2xl bg-sky-500 px-10 py-4 text-base font-bold text-slate-950 hover:bg-sky-400 transition-all hover:shadow-xl hover:shadow-sky-500/20"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
      ...
      {/* Footer */}
      <footer className="border-t border-slate-800/60 py-8 px-6 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          <p>
            <span className="font-bold text-slate-400">RAGTAILOR</span> —
